...
import { FaComment, FaBookOpen, FaPlayCircle, FaPaperPlane, FaHeart, FaSun, FaRegClock, FaHandHoldingHeart, FaUtensils } from "react-icons/fa";
import { GiHealthNormal, GiStomach } from "react-icons/gi";
import { MdPsychology, MdFastfood } from "react-icons/md";
...
const Eating = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      user: "Alex",
      text: "Today I challenged myself to eat three balanced meals. It was hard but I'm proud.",
      time: "2 hours ago",
      likes: 8,
    ...
    },
    {
      id: 2,
      user: "Sam",
      text: "Found this helpful: When meal times feel overwhelming, small portions are still progress.",
      time: "1 hour ago",
      likes: 12,
    ...
    },
    {
      id: 3,
      user: "Taylor",
      text: "Remember recovery isn't linear. Be gentle with yourself on tough days.",
      time: "45 minutes ago",
      likes: 15,
  ...
  const eatingDisorderFacts = [
    {
      icon: <MdPsychology className="text-2xl" />,
      title: "Clinical Definition",
      content: "Eating disorders are serious mental health conditions characterized by disturbances in eating behaviors and body image."
    },
    {
      icon: <GiStomach className="text-2xl" />,
      title: "Prevalence",
      content: "Affects at least 9% of the population worldwide, with increasing rates in adolescents and young adults."
    },
    {
      icon: <FaRegClock className="text-2xl" />,
      title: "Recovery Timeline",
      content: "With proper treatment, many see improvement within 3-6 months, though full recovery often takes years."
    }
  ];
  ...
  const copingStrategies = [
    {
      title: "Meal Support",
      description: "Eat with supportive people or use distraction techniques during meals.",
      icon: <FaUtensils className="text-blue-500" />
    },
    {
      title: "Body Neutrality",
      description: "Focus on what your body can do rather than appearance.",
      icon: <GiHealthNormal className="text-green-500" />
    },
    {
      title: "Urge Surfing",
      description: "Ride out urges to restrict/binge/purge without acting on them.",
      icon: <MdFastfood className="text-purple-500" />
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <div className="flex justify-center items-center mb-4">
              <GiHealthNormal className="text-4xl text-indigo-600 mr-3" />
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Recovery is possible. Eating disorders are treatable with the right support and care.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                ...
                <div className="p-6 md:p-8">
                  {activeTab === "symptoms" && (
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900 mb-4">Recognizing Eating Disorders</h2>
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Extreme preoccupation with weight, food, and body image</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Severe restriction of food intake (anorexia)</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Binge eating followed by purging (bulimia)</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Consuming unusually large amounts of food (binge eating disorder)</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Avoidance of certain foods (ARFID)</p>
                        </li>
                      </ul>
                    </div>
                  )}
                  ...
                  {activeTab === "causes" && (
                    <div>
                      ...
                      <p className="text-gray-700 mb-4">
                        Eating disorders result from a complex interaction of factors:
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {eatingDisorderFacts.map((fact, index) => (
                      ...
                      <div className="space-y-6">
                        <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-100">
                          ...
                          <p className="text-indigo-700">
                            CBT, DBT, and family-based therapy (FBT) are effective approaches.
                          </p>
                        </div>
                        <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                          <h3 className="font-semibold text-green-800 mb-2">Nutritional Counseling</h3>
                          <p className="text-green-700">
                            Registered dietitians help establish healthy eating patterns.
                          </p>
                        </div>
                        <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
                          <h3 className="font-semibold text-purple-800 mb-2">Medical Monitoring</h3>
                          <p className="text-purple-700">
                            Addressing physical health complications is often necessary.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 text-gray-800">
                      With treatment, <span className="font-medium">60% of people</span> with eating disorders achieve full recovery
                    </p>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mt-1">
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 text-gray-800">
                      Many recovery programs now focus on <span className="font-medium">health at every size</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-8 bg-red-50 rounded-2xl p-6 border border-red-200">
                ...
                <div className="space-y-3">
                  ...
                  <a href="https://www.nationaleatingdisorders.org" target="_blank" rel="noopener noreferrer" className="block px-4 py-2 bg-white text-red-600 rounded-lg border border-red-200 hover:bg-red-100 transition-colors font-medium">
