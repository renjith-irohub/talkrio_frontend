...
import { FaComment, FaBookOpen, FaPlayCircle, FaPaperPlane, FaHeart, FaSun, FaRegClock, FaHandHoldingHeart, FaPills } from "react-icons/fa";
import { GiHealthNormal, GiBreakingChain } from "react-icons/gi";
import { MdPsychology, MdLocalHospital } from "react-icons/md";
...
const Substance = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      user: "Alex",
      text: "Today marks 30 days sober. One day at a time really works.",
      time: "2 hours ago",
      likes: 8,
    ...
    },
    {
      id: 2,
      user: "Sam",
      text: "Found this helpful: When cravings hit, calling my sponsor helps me through.",
      time: "1 hour ago",
      likes: 12,
    ...
    },
    {
      id: 3,
      user: "Taylor",
      text: "Remember recovery isn't about perfection. Relapse can be part of the journey.",
      time: "45 minutes ago",
      likes: 15,
  ...
  const substanceFacts = [
    {
      icon: <MdPsychology className="text-2xl" />,
      title: "Clinical Definition",
      content: "Substance use disorder is a medical condition characterized by impaired control over substance use."
    },
    {
      icon: <FaPills className="text-2xl" />,
      title: "Prevalence",
      content: "Affects about 10% of US adults annually, with only about 10% receiving treatment."
    },
    {
      icon: <FaRegClock className="text-2xl" />,
      title: "Recovery Timeline",
      content: "Most treatment programs recommend at least 90 days for significant progress."
    }
  ];
  ...
  const copingStrategies = [
    {
      title: "Urge Surfing",
      description: "Ride out cravings without acting on them - they typically pass in 15-30 minutes.",
      icon: <GiBreakingChain className="text-blue-500" />
    },
    {
      title: "Support Network",
      description: "Build relationships with others in recovery for accountability.",
      icon: <GiHealthNormal className="text-green-500" />
    },
    {
      title: "Healthy Alternatives",
      description: "Replace substance use with exercise, hobbies, or other positive activities.",
      icon: <MdLocalHospital className="text-purple-500" />
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <div className="flex justify-center items-center mb-4">
              <GiBreakingChain className="text-4xl text-indigo-600 mr-3" />
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Recovery is possible. Every journey begins with a single step.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                ...
                <div className="p-6 md:p-8">
                  {activeTab === "symptoms" && (
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900 mb-4">Recognizing Substance Use Disorders</h2>
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Taking substances in larger amounts or longer than intended</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Persistent desire or unsuccessful efforts to cut down</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Craving or strong urge to use the substance</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Failure to fulfill major obligations at work, school, or home</p>
                        </li>
                        <li className="flex items-start">
                          <div className="flex-shrink-0 mt-1 mr-3 text-indigo-600">•</div>
                          <p className="text-gray-700">Continued use despite social or interpersonal problems</p>
                        </li>
                      </ul>
                    </div>
                  )}
                  ...
                  {activeTab === "causes" && (
                    <div>
                      ...
                      <p className="text-gray-700 mb-4">
                        Substance use disorders develop from multiple factors:
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {substanceFacts.map((fact, index) => (
                    ...
                    <div>
                      ...
                      <div className="space-y-6">
                        <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-100">
                          <h3 className="font-semibold text-indigo-800 mb-2">Behavioral Therapies</h3>
                          <p className="text-indigo-700">
                            CBT, contingency management, and motivational interviewing are effective approaches.
                          </p>
                        </div>
                        <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                          <h3 className="font-semibold text-green-800 mb-2">Medication-Assisted Treatment</h3>
                          <p className="text-green-700">
                            Medications can help manage withdrawal and cravings for certain substances.
                          </p>
                        </div>
                        <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
                          <h3 className="font-semibold text-purple-800 mb-2">Support Groups</h3>
                          <p className="text-purple-700">
                            12-step programs and other peer support networks provide community.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 text-gray-800">
                      About <span className="font-medium">75% of people</span> who develop addiction eventually recover
                    </p>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mt-1">
                    ...
                    <p className="ml-3 text-gray-800">
                      New treatments and medications are continually being developed
                    </p>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mt-1">
                    ...
                    <p className="ml-3 text-gray-800">
                      Many find recovery leads to <span className="font-medium">greater purpose</span> and life satisfaction
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 sticky top-8">
                <div className="p-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                  ...
                  <p className="text-indigo-100 mt-1">Support from others in recovery</p>
                </div>
              ...
              <div className="mt-8 bg-red-50 rounded-2xl p-6 border border-red-200">
                ...
                <div className="space-y-3">
                  ...
                  <a href="https://www.samhsa.gov" target="_blank" rel="noopener noreferrer" className="block px-4 py-2 bg-white text-red-600 rounded-lg border border-red-200 hover:bg-red-100 transition-colors font-medium">
