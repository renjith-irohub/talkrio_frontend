...
const Schizophreniavideo = () => {
  // List of videos (local & YouTube)
  const videos = [
    { type: "local", src: "/schizo-video.mp4", title: "Schizophrenia Overview" },
    { type: "local", src: "/sheiz-video2.mp4", title: "Living with Sleep Disorder" },
...
export default Schizophreniavideo;
